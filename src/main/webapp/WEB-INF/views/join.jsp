    ...
    <div class="join_in_box">
         <div class="content_box">
            ...
            <!-- 아이디 -->
                ...
                <!-- 비밀번호 -->
                <input type="password" value="" placeholder="비밀번호* (영문 대소문자/숫자/특수문자 중 2가지 이상 조합, 8자~16자)" class="psw i_type1" name="userPw" autocomplete="new-password" required>
<%--                <input type="password" placeholder="비밀번호 확인*" class="psw_chk i_type1" name="confrim_psw" autocomplete="new-password">--%>
                ...
                <div class="content_box">
                    <div class="document">
                       ...
                       <div class="docu_2_box db">
                             <div class="chk_box">
                                <input type="checkbox" name="chk_2" class="chk"> [필수] 이용약관 동의
                       ...
                       <div class="docu_3_box db">
                            <div class="chk_box">
                                <input type="checkbox" name="chk_3" class="chk"> [필수] 서비스이용 및 회원의 의무
                                <div class="chk_mark">∨</div>
                            </div>
                            <div class="docu_regulation">
                                <div class="frist">
                       ...
                       <div class="docu_4_box db">
                            <div class="chk_box">
                                <input type="checkbox" name="chk_4" class="chk"> [필수] 개인정보 보호 처리방침
                                <div class="chk_mark">∨</div>
                            </div>
                            <div class="docu_regulation">
                                <div class="frist">
